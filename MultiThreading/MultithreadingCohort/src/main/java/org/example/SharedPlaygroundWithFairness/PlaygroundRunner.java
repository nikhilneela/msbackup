...
public class PlaygroundRunner {
    ...
    public static void scenario2() {
        ...
        new Thread(() -> playground.play(new Player("A2", Team.A, 5*1000L, System.currentTimeMillis()))).start();
        Thread.sleep(500);

        new Thread(() -> playground.play(new Player("B1", Team.B, 5*1000L, System.currentTimeMillis()))).start();
        Thread.sleep(500);

        new Thread(() -> playground.play(new Player("B2", Team.B, 5*1000L, System.currentTimeMillis()))).start();
        Thread.sleep(500);

        new Thread(() -> playground.play(new Player("A3", Team.A, 5*1000L, System.currentTimeMillis()))).start();
        Thread.sleep(500);

        new Thread(() -> playground.play(new Player("A4", Team.A, 5*1000L, System.currentTimeMillis()))).start();
        Thread.sleep(500);

        new Thread(() -> playground.play(new Player("B3", Team.B, 5*1000L, System.currentTimeMillis()))).start();
        Thread.sleep(500);

        new Thread(() -> playground.play(new Player("B4", Team.B, 5*1000L, System.currentTimeMillis()))).start();
        Thread.sleep(500);
    }
}
